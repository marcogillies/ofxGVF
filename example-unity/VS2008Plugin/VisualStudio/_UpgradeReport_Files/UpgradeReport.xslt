...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:template match="Projects" mode="ProjectOverview">
    ...
    <table>
      <tr>
        <th></th>
        <th _locID="ProjectTableHeader">Progetto</th>
        <th _locID="PathTableHeader">Percorso</th>
        <th _locID="ErrorsTableHeader">Errori</th>
        <th _locID="WarningsTableHeader">Avvisi</th>
        <th _locID="MessagesTableHeader">Messaggi</th>
      </tr>
              ...
              <a>
                ...
                <xsl:choose>
                  <xsl:when test="@ProjectDisplayName = ''">
                    <span _locID="OverviewSolutionSpan">Soluzione</span>
                  </xsl:when>
                  <xsl:otherwise>
    ...
    <tr>
      ...
      <td class="messageCell">
        ...
        <a _locID="ShowAdditionalMessages" href="#">
          ...
          Mostra <xsl:value-of select="@MessageCount"/> messaggi aggiuntivi
        </a>
      </td>
    </tr>
  </xsl:template>
    ...
    <tr style="display: none">
      ...
      <td class="messageCell">
        ...
        <a _locID="HideAdditionalMessages" href="#">
          ...
          Nascondi <xsl:value-of select="@MessageCount"/> messaggi aggiuntivi
        </a>
      </td>
    </tr>
  </xsl:template>
  ...
  <xsl:template match="Projects" mode="ProjectDetails">
    ...
    <xsl:for-each select="Project">
      ...
      <xsl:choose>
        <xsl:when test="@ProjectDisplayName = ''">
          <h3 _locID="ProjectDisplayNameHeader">Soluzione</h3>
        </xsl:when>
        <xsl:otherwise>
          <h3>
            <xsl:value-of select="@ProjectDisplayName"/>
      ...
      <table>
        <tr>
          ...
          <th></th>
          <th class="messageCell" _locID="MessageTableHeader">Messaggio</th>
        </tr>
              ...
              <xsl:choose>
                <xsl:when test="@ProjectDisplayName = ''">
                  <td class="messageCell" _locID="NoMessagesRow2">
                    La soluzione non ha registrato alcun messaggio.
                  </td>
                </xsl:when>
                <xsl:otherwise>
                  <td class="messageCell" _locID="NoMessagesRow">
                    <xsl:value-of select="@ProjectDisplayName"/> registrato nessun messaggio.
                  </td>
                </xsl:otherwise>
              </xsl:choose>
            </tr>
    ...
    <html>
      ...
      <body>
        <h1 _locID="ConversionReport">
          Report di migrazione - <xsl:value-of select="Properties/Property[@Name='Solution']/@Value"/>
        </h1>

        <div id="content">
          <h2 _locID="OverviewTitle">Panoramica</h2>
          ...
          <h2 _locID="SolutionAndProjectsTitle">Soluzione e progetti</h2>
